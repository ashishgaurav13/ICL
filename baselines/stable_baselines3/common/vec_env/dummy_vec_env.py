...
class DummyVecEnv(VecEnv):
    ...
    def step_wait(self):
        for env_idx in range(self.num_envs):
            step_data = self.envs[env_idx].step(
                self.actions[env_idx]
            )
            obs, self.buf_rews[env_idx], self.buf_dones[env_idx], self.buf_infos[env_idx] = step_data["next_state"],\
                step_data["reward"], step_data["done"], step_data["info"]
